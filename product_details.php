            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <a href="#" class="heart-icon"><span class="icon_heart_alt"><i class="fa-regular fa-heart"></i></span></a>
                        <ul>
                ...
                <div class="col-lg-12">
                    <div class="product__details__tab">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs2" role="tab" aria-selected="false">Information</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs3" role="tab" aria-selected="false">Reviews <span>(1)</span></a>
                            </li>
                        </ul>
        ...
        <div class="container">
            ...
            <div class="row">
                <?php if (isset($_SESSION['user'])) {
                    foreach ($products->getProducts($_SESSION['user']['id']) as $index => $row) {
                        if ($index < 4) { ?>
