                            ...
                            <td>
                                <div class="btns d-flex gap-2">
                                    <form method="post">
                                        ...
                                        <button type="submit" name="delete-category" class="btn btn-danger"><i class="fa-solid fa-trash"></i></button>
                                    </form>
                                    <form method="get">
                                        <input type="hidden" value="<?= $row['id'] ?? 0 ?>" name="item_id">
                                        <a href="./admin_edit_category.php?id=<?= $row['id'] ?? 0 ?>" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                                    </form>
                                </div>
                            </td>
                        </tr>
